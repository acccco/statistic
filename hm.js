(function () {
    ...
    var h = {}
      , mt = {}
      , c = {
      id: "018544f3cb6861c3cd0e6628507a9933",
      dm: ["youle.izhuan100.com"],
      bjs: "tongji.baidu.com/hm-web/js/",
      etrk: [],
      icon: '',
      ctrk: false,
      align: -1,
      ...
      (function () {
          if (!d)
            ...
            "complete" === document.readyState)
              ...
              document.addEventListener("DOMContentLoaded", g, u),
    ...
    mt.localStorage.set = function (a, b, d) {
      ...
      try {
        window.localStorage ? (b = f.getTime() + "|" + b,
          window.localStorage.setItem(a, b)) : mt.localStorage.C() && (mt.localStorage.g.expires = f.toUTCString(),
    ...
    mt.aa.log = function (a, b) {
      var d = new Image
        , f = "_zklog_mini_tangram_log_" + Math.floor(2147483648 * Math.random()).toString(36);
      window[f] = d;
    ...
    (function () {
        ...
        var g = mt.event, n = h.G, l = r, p = r, e = r, k = r, w = +new Date, m = w, s = 0, y = r,
          v = d("visibilityState"), x = d("hidden"), z;
        b();
        (function () {
            var a = v.replace(/[vV]isibilityState/, "visibilitychange");
            // 被隐藏或显示的时候会触发visibilitychange事件
            g.c(document, a, b);
            // 页面显示触发，比如历史记录的前进后退
            g.c(window, "pageshow", b);
            // 页面消失触发，比如历史记录的前进后退
            g.c(window, "pagehide", b);
            "object" == typeof document.onfocusin ? (g.c(document, "focusin", f),
              g.c(document, "focusout", f)) : (g.c(window, "focus", f),
              g.c(window, "blur", f))
          }
        )();
        // 记录用户停留时间，就是窗口激活的事件
    ...
    (function () {
        var a = mt.lang
          ...
          , f = {
          Ca: function (g) {
            if ((window._zklog_dxt === q || a.d(window._zklog_dxt, "Array")) && "undefined" !== typeof h.b) {
              var f = h.b.I();
          ...
          Ma: function (d) {
            if (a.d(d, "String") || a.d(d, "Number"))
              window._zklog_dxt = window._zklog_dxt || [],
                window._zklog_dxt.push(["_setUserId", d])
          }
        };
        return h.ha = f
      }
    ...
    (function () {
        // 返回格式 作用范围*key*value!作用范围*key*value...
        function a(a, d, m, b) {
          if (!(a === q || d === q || b === q)) {
            if ("" === a)
              return [d, m, b].join("*");
        ...
        var d = mt.lang
          ...
          // 初始化 _hmt 对象，用于存放插件
          ia: function () {
            var a = window._zklog_hmt || [];
            if (!a || d.d(a, "Array"))
              window._zklog_hmt = {
                id: c.id,
                cmd: {},
                push: function () {
                  for (var a = window._zklog_hmt, k = 0; k < arguments.length; k++) {
                    var b = arguments[k];
                ...
                window._zklog_hmt.cmd[c.id] = [],
                window._zklog_hmt.push.apply(window._zklog_hmt, a)
          },
          // 处理插件格式
          la: function () {
            var a = window._zklog_hmt;
          ...
          _setCustomVar: function (a) {
            if (!(4 > a.length)) {
              ...
              if (0 < b && 6 > b && 0 < m && 4 > m) {
                e.B++;
                for (var s = (h.b.a.cv || "*").split("!"), f = s.length; f < b - 1; f++)
                  s.push("*");
                s[b - 1] = m + "*" + d.j(a[2]) + "*" + d.j(a[3]);
                h.b.a.cv = s.join("!");
                a = h.b.a.cv.replace(/[^1](\*[^!]*){2}/g, "*").replace(/((^|!)\*)+$/g, "");
                "" !== a ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age) : h.b.Fa("Hm_cv_" + c.id)
              }
            }
          },
          ...
          _setReferrerOverride: function (a) {
            1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? n.protocol + "//" + window.location.host + a[1] : a[1],
              e.Y = r)
          },
          ...
          _trackRTEvent: function (a) {
            ...
            if (d.d(a, "Object")) {
              ...
              if (900 >= m)
                ...
                for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.P).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++)
                  l.push(v),
                    l.push(a.substring(900 * v, 900 * v + 900)),
                    g.call(this, s + l.join("|")),
                    l = []
            }
          },
    ...
    (function () {
        function a() {
          "undefined" === typeof window["_zklog_bdhm_loaded_" + c.id] && (window["_zklog_bdhm_loaded_" + c.id] = r,
            this.a = {},
            this.X = r,
            this.M = u,
            this.init())
        ...
        a.prototype = {
          ...
          // 返回类列表中的主域名，如果没有则返回当前域名，用于 cookie
          I: function () {
          ...
          V: function () {
            for (var a = 0, b = c.dm.length; a < b; a++) {
              var d = c.dm[a];
              if (-1 < d.indexOf("/") && this.Z(document.location.href, d))
                return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
            }
            return "/"
          },
          // 判断上次浏览的间隔时间
          // k.r 上次进入时间 k.m 这次进入时间 c.vdur 1800000 秒 500 小时
          // 返回
          // 1 间隔超过 500 小时                      session 级别的第一次进入
          // 4 间隔时间未超过 500 小时                 同域名下跳转
          // 3 间接访问，跳转的路径并不在允许列表中      外部链接访问 可以肯定是第一次 session 级别
          ta: function () {
            if (!document.referrer)
              return k.m - k.r > c.vdur ? 1 : 4;
            var a = u;
            this.z(document.referrer) && this.z(document.location.href) ? a = r : (a = b.W(document.referrer),
              a = this.N(a || "", document.location.hostname));
            return a ? k.m - k.r > c.vdur ? 1 : 4 : 3
          },
          // 从 cookie > session > local
          getData: function (a) {
            try {
          ...
          // setData 先设置 cookie 在设置 storage
          ...
          // 初始化 nv st cc lt lv 参数
          // nv 0 > 直接访问，且有效，未超时（1800000） 1 > 其他
          // st 1 > 直接访问，超时 3 > 间接访问 4 > 直接访问，有效
          // lt 最近一次访问时间
          // lv 1 > 首次访问 2 > 已访问了4个以下页面 3 > 4个页面以上
          // cc
          Ka: function () {
            var a, b, d, e, f;
            // 获取进入时间
          ...
          Ja: function () {
            ...
            // sn 是一个根据当前时间对 65535 取余出来的值，作用不明，确定某个时间点？
            switch (b) {
              case 0:
                a.push("sn=" + k.U);
          ...
          ga: function () {
            ...
            a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * k.P),
        ...
        try {
          if (window.performance && performance.timing && "undefined" !== typeof h.b) {
            var d = function (a) {
              ...
              var f = d("request");
              a = {
                netAll: f.start - a.start,// 浏览器准备时间，大概等于 dns + tcp
                netDns: d("domainLookup").value, // dns 解析时间
                netTcp: d("connect").value, // tcp 链接时间
                srv: d("response").start - f.start, // 服务器响应请求时间
                dom: performance.timing.domInteractive - performance.timing.fetchStart, // dom 解析时间
                loadEvent: d("loadEvent").end - a.start // 资源加载消耗的时间
              };
              // log
              // 浏览器首屏加载时间分析
              h.b.a.et = 87;
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.Da || 7 < a.Ba) && c.cvcc)) {
          ...
          if (c.med)
            n = "/zoosnet",
              ...
              p = {
                click: function () {
                  for (var a = [], b = e(document.getElementsByTagName("a")), b = [].concat.apply(b, e(document.getElementsByTagName("area"))), b = [].concat.apply(b, e(document.getElementsByTagName("img"))), d, f, g = 0, k = b.length; g < k; g++)
                    d = b[g],
                      f = d.getAttribute("onclick"),
                      d = d.getAttribute("href"),
                    (l.test(f) || l.test(d)) && a.push(b[g]);
                  return a
                }
              };
          else if (c.cvcc) {
            ...
            p = {
              click: function () {
                for (var a = [], b = e(document.getElementsByTagName("a")), b = [].concat.apply(b, e(document.getElementsByTagName("area"))), b = [].concat.apply(b, e(document.getElementsByTagName("img"))), d, f, g, k = 0, n = b.length; k < n; k++)
                  d = b[k],
                    l !== q ? (f = d.getAttribute("onclick"),
                      g = d.getAttribute("href"),
                      m ? (d = d.getAttribute("id"),
                      (l.test(f) || l.test(g) || m.test(d)) && a.push(b[k])) : (l.test(f) || l.test(g)) && a.push(b[k])) : m !== q && (d = d.getAttribute("id"),
                    m.test(d) && a.push(b[k]));
                return a
              }
            }
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
          var g = {
            ca: function () {
              for (var b = c.cvcf.length, f, p = 0; p < b; p++)
                (f = a.oa(decodeURIComponent(c.cvcf[p]))) && d.c(f, "click", g.ka())
            },
            ka: function () {
              return function () {
                h.b.a.et = 86;
                ...
                a.id = this.id;
                // log
                // 发送点击事件，但是 cvcf 里面并没有值，所以应该是没用的
                // cvcf 里面存的应该是 id 可以监控 id 对应 dom 元素的点击事件
                // ep 固定 为 a 不会变 n/t/id
                // 触发时间：对应元素点击的时候
                h.b.a.ep = f.stringify(a);
                h.b.k()
              }
    ...
    (function () {
        ...
        if (c.med && "undefined" !== typeof h.b) {
          var d = +new Date
            ...
            // log
            // 统计页面上的 click keyup scroll 触发的次数
            // 86 事件统计
            // sb 滚动次数
            // kb 键盘点击次数
            // clk 鼠标点击次数
